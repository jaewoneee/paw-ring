...
### 완료 실행자 추적
- [ ] 완료/무시 상태 변경 시 실행자(completed_by) 기록 — `schedule_completions` 테이블 기존 스키마 활용
- [ ] 2인 이상 공유 캘린더에서 완료/무시된 스케줄에 실행자 닉네임 표시
- [ ] 본인 완료: "내가 완료" / 타인 완료: "OO님이 완료"
