...
### 스케줄 카테고리 (기본)
- [x] 기본 카테고리: 산책, 식사, 병원, 약 투여, 목욕, 기타
- [x] 카테고리별 색상/아이콘
- [ ] 카테고리별 필터링

### 커스텀 카테고리 관리
- [x] 커스텀 카테고리 생성 (카테고리명 + 색상 선택)
- [x] 커스텀 카테고리 수정 (이름/색상 변경)
- [x] 커스텀 카테고리 삭제 (해당 카테고리 사용 중인 스케줄은 "기타"로 변경)
- [x] 기본 카테고리는 삭제 불가, 색상만 커스터마이징 가능
- [x] 카테고리 목록 관리 화면 (설정 또는 캘린더에서 진입)
- [x] 스케줄 생성/수정 시 커스텀 카테고리 선택 가능
- [x] 색상 프리셋 팔레트 제공 (12~16색)
