...
| #   | 기능                                 | 상태 | 상세 문서                               |
| --- | ------------------------------------ | ---- | --------------------------------------- |
| 0.1 | 컬러 시스템 (포인트 컬러 + 다크모드) | ✅   | [color.md](./design/color.md)           |
| 0.2 | 타이포그래피 시스템                  | ✅   | [typography.md](./design/typography.md) |
| 0.3 | 공통 컴포넌트 라이브러리             | 🔧   |                                         |
...
| #   | 기능                          | 상태 | 상세 문서                                                |
| --- | ----------------------------- | ---- | -------------------------------------------------------- |
| 6.1 | 반려동물별 활동 타임라인 화면 | ✅   | [care-activity-feed.md](./feature/care-activity-feed.md) |
| 6.2 | 날짜별 그룹핑 + 완료자 표시   | ✅   | [care-activity-feed.md](./feature/care-activity-feed.md) |
| 6.3 | 홈 화면 "최근 활동" 섹션      | ✅   | [care-activity-feed.md](./feature/care-activity-feed.md) |
| 6.4 | 카테고리/기간 필터            | ⬜   | [care-activity-feed.md](./feature/care-activity-feed.md) |
