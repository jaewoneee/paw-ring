...
코드 품질, 성능, UI/UX 등 구조적 개선 과제를 추적하는 문서.

- 이 `README.md`가 전체 개선 목록과 진행 상태를 관리
- 개별 `.md` 파일은 규모가 큰 개선 과제의 상세 계획 (예: TanStack Query 마이그레이션)
...
| 4.4 | 낙관적 업데이트 패턴 개선 (롤백 일관성, invalidate 범위, 깜빡임 방지) | ✅ |
